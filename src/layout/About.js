                    ...
                    <Col sm={16} style={{display:'flex',flexDirection:'column',justifyContent:'center',alignItems:'center'}}>
                        {
                            show && (
                                <Fade delay={700}>
                                    ...
                                    I am a creative and self-motivated Senior Frontend Web and Smart Contract Developer with 7+ years of experience developing useful, approachable user interfaces. <i style={{color:'red'}}>All You Need is A!</i>
                                    </div>
                                </Fade>
                            )
                        }
